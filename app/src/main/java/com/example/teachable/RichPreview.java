...
public class RichPreview {
    ...
    private class getData extends AsyncTask<Void , Void , Void> {
        ...
        protected Void doInBackground(Void... params) {
            Document doc = null;
            try {
                Log.e("RichPreview", url);
                doc = Jsoup.connect(url)
                        .timeout(30*1000)
                        .userAgent("Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101")
                        .get();

                Elements elements = doc.getElementsByTag("meta");

                Log.e("RichPreview", elements.toString());
                ...
                e.printStackTrace();
                Log.e("RichPreview", e.toString());
                Log.e("RichPreview", new Exception("No Html Received from " + url + " Check your Internet " + e.getLocalizedMessage()).toString());
